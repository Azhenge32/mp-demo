...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("2349552a");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        pc.setParent("com.az.mpdemo");
        ...
        if(scanner("是否继承基类").equalsIgnoreCase("y")) {
            strategy.setSuperEntityClass("com.az.mpdemo.entity.BaseEntity");
        ...
        strategy.setTableFillList(Arrays.asList(createTime, modifiedTime, createAccountId, modifiedAccountId));
